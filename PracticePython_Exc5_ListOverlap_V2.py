...
#user checks with list to see if value is present or not.
num_data = int(raw_input("Number to check in list: "))
print num_data
string =''
for data in c:
    if num_data == data:
        string = "Yes %s is in the dataset." % data
        break
    else:
        string = "Data is not listed. Please try again."
print string
